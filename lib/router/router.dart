...
import 'package:flutter00/router/pages/seventeen.dart';
import 'package:flutter00/router/pages/eighteen.dart';
import 'package:flutter00/router/pages/nineteen.dart';
...
import 'package:flutter00/router/pages/twentyfour.dart';
import 'package:flutter00/router/pages/twentyfive.dart';
import 'package:flutter00/router/pages/twentysix.dart';
import 'package:flutter00/router/pages/twentyseven.dart';
import 'package:flutter00/router/pages/twentyeight.dart';
import 'package:flutter00/router/pages/twentynine.dart';
import 'package:flutter00/router/pages/thirty.dart';
...
final routes = {
  ...
  '/seventeenth': (BuildContext context) => const SeventeenPage(),
  '/eighteenth': (BuildContext context) => const EighteenPage(),
  '/nineteenth': (BuildContext context) => const NineteenPage(),
  ...
  '/twentyfourth': (BuildContext context) => const TwentyFourPage(),
  ...
  '/twentyninth': (BuildContext context) => const TwentyNinePage(),
  '/thirtieth': (BuildContext context) => const ThirtyPage(),
};
